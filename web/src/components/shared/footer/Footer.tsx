                ...
                <div className={'footer__row'}>
                    <div className='footer__row1__social'>
                        <a className='footer__social-item' href='#'>
                            <img alt='twitter' src={twitter} /></a>
                        <a className='footer__social-item' href='#'>
                            <img alt='facebook' src={facebook} /></a>
                        <a className='footer__social-item ' href='#'>
                            <img alt='instagram' src={instagram} /></a>
                        <a className='footer__social-item ' href='#'>
                            <img alt='pinterest' src={pinterest} /></a>
                    </div>
                    <div className='footer__row1__policy'>
                        <a className='footer__policy-item' href='#'>Returns Policy</a>
                        <a className='footer__policy-item' href='#'>Privacy Policy</a>
                        <a className='footer__policy-item' href='#'>Privacy Policy</a>
                    </div>
